...
class Event extends AppModel {
    ...
    public $hasAndBelongsToMany = array(
        ...
        'RegistrationType' => array(
            ...
            'joinTable' => 'events_registration_types',
            'foreignKey' => 'event_id',
            'associationForeignKey' => 'registration_type_id',
            'unique' => 'keepExisting',
            'conditions' => '',
            'fields' => '',
            'order' => '',
