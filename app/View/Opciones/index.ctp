<div class="opciones index">
	...
	<tr>
		<td><?php echo h($opcione['Opcione']['id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($opcione['PersonalDatum']['id'], array('controller' => 'personal_data', 'action' => 'view', $opcione['PersonalDatum']['id'])); ?>
		</td>
		<td><?php echo h($opcione['Opcione']['descripcion']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $opcione['Opcione']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $opcione['Opcione']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $opcione['Opcione']['id']), array(), __('Are you sure you want to delete # %s?', $opcione['Opcione']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
