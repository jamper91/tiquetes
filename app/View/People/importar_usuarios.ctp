...
?>
<div align="center">
    <?php echo $this->Form->create('People', array('action' => 'importarUsuarios')); ?>
...
//        $urlnueva = "../vendor/xls/empleados.xls";
    ...
    <!--            <th>TELEFONO</th>
            ...
                <tbody>
                ...
                if (isset($_POST['radio'])) {
                    ...
                    $objPHPExcel = PHPExcel_IOFactory::load('../vendor/xls/empleados.xls');
