...
<?php echo $this->Form->create('EntradasInput'); ?>
	<fieldset>
		<legend><?php echo __('Edit Entradas Input'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EntradasInput.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('EntradasInput.id'))); ?></li>
