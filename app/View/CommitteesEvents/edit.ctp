...
<?php echo $this->Form->create('CommitteesEvent'); ?>
	<fieldset>
		<legend><?php echo __('Edit Committees Event'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CommitteesEvent.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('CommitteesEvent.id'))); ?></li>
